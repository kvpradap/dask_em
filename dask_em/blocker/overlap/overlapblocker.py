...
from dask_em.blocker.blocker_utils import get_attrs_to_project, \
    get_lattrs_to_project, get_rattrs_to_project
from dask_em.blocker.overlap.overlapprober import OverlapProber
from dask_em.tokenizer.qgramtokenizer import QgramTokenizer
from dask_em.tokenizer.whitespacetokenizer import WhiteSpaceTokenizer
from dask_em.utils.cy_utils.stringcontainer import StringContainer
from dask_em.utils.py_utils.utils import str2bytes, split_df, build_inv_index, \
...
class OverlapBlocker(object):
    ...
    def block_candset(self, candset, ltable, rtable, fk_ltable, fk_rtable, l_key,
        ...
        for i in range(candset.npartitions):
            result = delayed(self._block_candset_part)(candset.get_partition(i), ltable,
                                                       rtable,
                                                       fk_ltable,
