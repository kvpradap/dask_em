...
from dask_em.utils.py_utils.utils import split_df, proj_df, add_attributes, concat_df, \
...
class BlackBoxBlocker(object):
    ...
    def block_tables(self, ltable, rtable, l_key, r_key, l_output_attrs=None,
        ...
        for i in ltable.npartitions:
            ...
            for j in xrange(rtable.npartitions):
                ...
                result = delayed(self._block_tables_part)(ltable.get_partition(i),
    ...
    def block_candset(self, candset, ltable, rtable, fk_ltable, fk_rtable, l_key, r_key,
        ...
        for i in range(candset.npartitions):
            result = delayed(self._block_candset_part)(candset_splitted.get_partition(i),
                                                       ltable,
                                                       rtable,
