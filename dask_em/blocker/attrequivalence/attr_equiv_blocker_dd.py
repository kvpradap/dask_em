...
from dask_em.utils.py_utils.utils import add_attributes, rename_cols
from dask_em.utils.py_utils.utils import split_df, proj_df, concat_df, add_id, \
...
class AttrEquivalenceBlocker(object):
    ...
    def block_tables(self, ltable, rtable, l_key, r_key, l_block_attr, r_block_attr,
        ...
        for i in xrange(ltable.npartitions):
            ...
            for j in xrange(rtable.partitions):
