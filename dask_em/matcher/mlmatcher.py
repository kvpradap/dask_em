...
from dask_em.utils.py_utils.utils import check_attrs_present, list_drop_duplicates, \
    list_diff, concat_df, candsplit_df, exec_dag
from dask_em.matcher.matcher import Matcher
...
class MLMatcher(Matcher):
    ...
    def predict(self, table, exclude_attrs=None, target_attr=None, append=False,
                inplace=True,
