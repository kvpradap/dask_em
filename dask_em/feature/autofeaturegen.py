...
import dask_em.feature.attributeutils as au
import dask_em.feature.simfunctions as sim
import dask_em.feature.tokenizers as tok
...
def fill_fn_template(attr1, attr2, sim_func, tok_func_1=None, tok_func_2=None):
    ...
    s = 'from dask_em.feature.simfunctions import *\nfrom ' \
        'dask_em.feature.tokenizers import *\n'
